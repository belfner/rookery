...
class SystemLinker:
    ...
    def __init__(
        ...
        bin_dir : Path, optional
            System binary directory. Defaults to value from ROOST_BIN_DIR or /usr/local/bin.
        desktop_dir : Path, optional
            Desktop entries directory. Defaults to value from ROOST_DESKTOP_DIR or /usr/share/applications.
        man_dir : Path, optional
            System man pages directory. Defaults to value from ROOST_MAN_DIR or /usr/share/man.
